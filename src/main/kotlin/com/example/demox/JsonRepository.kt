...
import com.example.demox.JsonData
...
interface JsonRepository {
    ...
    @Select("SELECT * FROM RE_GetGeoJsonInBox(ST_Transform(ST_SetSRID(" +
    ...
    @Select("SELECT CAST(ST_X(POINT) AS INT) x, CAST(ST_Y(POINT) AS INT) y " +
