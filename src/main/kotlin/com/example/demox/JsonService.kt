...
//    private val _Path3 = "C:\\geojson3\\"
  ...
  private fun getBound(x: Int, Nrange: Int): Int {
    val xx = (x / 1000).toInt()
    return (xx - Nrange) * 1000
  }
  ...
  @Throws
  fun getGeoJsonInRange(lat: Double, lon: Double, range: Int): String {
    ...
    val regionMeter: Int = (range * 2 + 1) * 1000
    
    return jsonRepo.getGeoJson(x, y, x + regionMeter, y + regionMeter).re_getgeojsoninbox
  }
